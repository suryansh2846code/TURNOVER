"""Provider capability registry for TURNOVER / Chitragupta.
...
CAPABILITIES_REGISTRY: dict[str, ProviderCapabilities] = {
    ...
    "cursor": ProviderCapabilities(
        ...
        # here would end without a credential Chitragupta can use.
    ...
    "subscription": ProviderCapabilities(
        ...
        description="Any OpenAI-compatible gateway you run, set via CHITRAGUPTA_SUBSCRIPTION_BASE_URL.",
        api_key_supported=True,
        oauth_supported=False,
        browser_login_supported=False,
        device_login_supported=False,
