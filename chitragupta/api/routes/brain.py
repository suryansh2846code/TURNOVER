...
def brain_export():
    ...
    return Response(
        ...
        headers={"Content-Disposition": f'attachment; filename="chitragupta-brain-{stamp}.json"'})


class ImportIn(BaseModel):
    memories: list[dict[str, Any]] = []
    chitragupta_backup: int | None = None
...
def canonical_export():
    """Regenerate the Markdown/JSON mirror under ~/Library/Chitragupta/brain-export."""
