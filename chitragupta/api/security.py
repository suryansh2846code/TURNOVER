...
Chitragupta's API is the user's machine in miniature: it lists their home
...
_FOREIGN_SITE = "Chitragupta ignores requests that come from a website."
_FOREIGN_HOST = "Chitragupta ignores requests addressed to another machine."
