...
_NOISE = {
    ...
    "some", "more", "most", "other", "such", "than", "each",
    ...
    "code", "line", "lines", "block", "node", "key", "keys", "hook",
    ...
    "priority", "severity", "category", "version", "author",
    ...
    "prove", "derive", "calculate", "find", "show", "solve",
    "solved", "attempt", "marks", "mark", "unit", "ans", "question", "questions",
    "chapter", "topic", "topics", "paper", "exam", "assignment", "syllabus",
    "human", "body", "right", "left", "self", "thus", "hence", "given", "consider", "assume", "suppose", "hello", "hi", "thanks", "thank", "regards",
    "dear", "best", "great", "good", "welcome", "please", "kindly", "yours",
    "figure", "diagram", "theorem",
    "definition", "values",
...
_COMMON = {
    ...
    "told", "ask", "asks", "asked", "found", "become", "becomes", "leave",
    ...
    "power", "energy", "force", "body", "bodies", "mind", "heart",
