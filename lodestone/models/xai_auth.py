"""Reading the xAI credential a previous Lodestone version stored.
...
`b1a00492-…` with `referrer=opencode` — neither of which belong to Lodestone.
...
do, and it makes every Lodestone user's sign-in breakable by a vendor decision
