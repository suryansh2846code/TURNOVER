...
Only two wire formats are needed for every backend Lodestone supports, which is
...
* **OpenAI chat-completions** — the OpenAI API, OpenRouter, Ollama, DeepSeek,
  xAI and Gemini (which Lodestone reaches through Google's OpenAI-compatible
