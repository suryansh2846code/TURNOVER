...
nothing; `LODESTONE_DEBUG=1` turns it on, and a rotating file in the Lodestone
...
def configure(force: bool = False) -> None:
    ...
    root.setLevel(logging.DEBUG if os.environ.get("LODESTONE_DEBUG") else logging.INFO)
    ...
    if directory is not None:
        try:
            ...
            handler = RotatingFileHandler(
                directory / "lodestone.log", maxBytes=2_000_000, backupCount=3,
                encoding="utf-8")
