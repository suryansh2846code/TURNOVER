...
const MODEL_HINTS = {
  ...
  openai: "e.g. gpt-5.6-terra, gpt-5.6-luna, gpt-5.5, gpt-5.6-sol",
...
const FALLBACK_CATALOG = [
  ...
  { id: "openai", label: "OpenAI", key_env: "OPENAI_API_KEY", key_url: "https://platform.openai.com/api-keys", destination: "Sent to OpenAI's API.", locality: "cloud", default_model: "gpt-5.6-terra", models: [{ id: "gpt-5.6-terra", name: "GPT-5.6-Terra", desc: "Balanced agentic coding model for everyday work" }, { id: "gpt-5.6-luna", name: "GPT-5.6-Luna", desc: "Fast and affordable agentic coding model" }, { id: "gpt-5.5", name: "GPT-5.5", desc: "Proven model for coding and general work" }, { id: "gpt-5.6-sol", name: "GPT-5.6-Sol", desc: "Flagship agentic coding model for complex tasks" }, { id: "gpt-6-astra", name: "GPT-6-Astra", desc: "Our most capable model for complex, demanding work" }, { id: "gpt-reserve", name: "GPT-Reserve", desc: "Fast backup agentic coding model" }, { id: "gpt-4o", name: "GPT-4o", desc: "Omni flagship for general tasks" }, { id: "gpt-4o-mini", name: "GPT-4o Mini", desc: "Fast, affordable intelligence" }] },
