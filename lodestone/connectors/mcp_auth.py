"""Signing in to a remote connector, without Lodestone owning an OAuth client.
...
CLIENT_NAME = "Lodestone"
CLIENT_URI = "https://lodestone.app"
...
<div><b>Connected.</b><p>You can close this tab and go back to Lodestone.</p></div>
"""
...
<div><b>That didn't complete.</b><p>Go back to Lodestone and try connecting again.</p></div>
"""
